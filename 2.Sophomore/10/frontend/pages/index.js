    ...
    <div className={inter.className}>
      ...
      <div className={styles.main}>
        <div>
          ...
          <div className={styles.description}>
            Your CryptoDevs NFT Balance: {String(nftBalanceOfUser.data)}
            <br />
            {daoBalance.data && (
              <>
                Treasury Balance:{" "}
            ...
            <br />
            Total Number of Proposals: {String(numOfProposalsInDAO.data)}
          </div>
          <div className={styles.flex}>
            <button
          ...
          {renderTabs()}
          {address && address.toLowerCase() === String(daoOwner.data).toLowerCase() ? (
            <div>
              {loading ? (
